 ...
 * Original file: C:\\Users\\Administrator\\git\\Quicklic\\Quicklic\\src\\quicklic\\floating\\api\\FloatingInterfaceAIDL.aidl
 */
package quicklic.floating.api;
public interface FloatingInterfaceAIDL extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements quicklic.floating.api.FloatingInterfaceAIDL
{
private static final java.lang.String DESCRIPTOR = "quicklic.floating.api.FloatingInterfaceAIDL";
...
/**
 * Cast an IBinder object into an quicklic.floating.api.FloatingInterfaceAIDL interface,
 * generating a proxy if needed.
 */
public static quicklic.floating.api.FloatingInterfaceAIDL asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof quicklic.floating.api.FloatingInterfaceAIDL))) {
return ((quicklic.floating.api.FloatingInterfaceAIDL)iin);
}
return new quicklic.floating.api.FloatingInterfaceAIDL.Stub.Proxy(obj);
}
...
private static class Proxy implements quicklic.floating.api.FloatingInterfaceAIDL
{
